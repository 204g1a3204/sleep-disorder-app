    ...
    if (!isMasterKeyUsed && !isStandardAdmin) {
        return res.send(`
            <body style="background:#050a14; color:white; text-align:center; padding-top:100px; font-family:Arial;">
                ...
                <a href="/admin-login" style="color:#f39c12; text-decoration:none; font-weight:bold;">← Go Back to Login</a>
            </body>
        `);
    }
        ...
        <tr class="search-row" style="border-bottom: 1px solid #333; background: ${isHighRisk ? 'rgba(255, 77, 77, 0.05)' : 'transparent'};">
            ...
            <td style="padding:15px;">
                <div style="display:flex; gap:10px;">
                    <a href="/view-report?id=${r.id}" target="_blank" style="background:#f39c12; color:white; padding:8px 12px; text-decoration:none; border-radius:5px; font-size:0.8rem; font-weight:bold;">REPORT</a>
